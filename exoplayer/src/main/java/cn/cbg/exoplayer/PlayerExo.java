...
import cn.cbg.exoplayer.utils.SettingIml;
import cn.cbg.exoplayer.utils.SettingReceiver;
        ...
        if (adTagUriString.length() > 0) {
            ...
            if (!adTagUri.equals(loadedAdTagUri)) {
                ...
                if (isImageAds(adsUrl)) {
                    ...
                    MediaSource adsMediaSource = buildMediaSource(adTagUri, null);
                    if (adsMediaSource != null) {
                        mediaSource.addMediaSource(0, adsMediaSource);
                    }
                }
            }
        } else {
