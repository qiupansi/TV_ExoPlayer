...
public class PlayerView extends FrameLayout implements AdsLoader.AdViewProvider, PlayerControlView.PlayOrPauseStatus, PlayerControlView.VisibilityListener {
    @Override
    ...
    private boolean isPlayingAd() {//player.isPlayingAd()&&
